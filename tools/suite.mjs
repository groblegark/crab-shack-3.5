...
scenario("hours: defaults are behavior-identical (frozen day-2 fingerprint)", () => {
  ...
  const want = {
    ...
    // (values settled at the visTick placement - the line's re-think fires in
    // the call both backends share, and the counts below read the same on
    // wasm and the reference, which is the whole point of where it lives.)
    1337: '{"day":3,"tmin":0,"coins":20261,"rep":56393,"catch":1,"serves":47,"crabServes":2,"rage":3,"till":20054,"wallets":[["PINCHY",1600],["CLAWDIA",1600],["SUDSY",20054],["REEF",28183],["SALTY",100],["DRIFT",300],["KELP",100]],"pos":[[520,154],[108,154],[388,154],[646,163],[2072,154],[318,167],[454,163]]}',
    // 4242 re-pointed with the same holder: serves 44 -> 51 and rage 4 -> 7
    // - the OTHER honest direction. More plans changed means more counters
